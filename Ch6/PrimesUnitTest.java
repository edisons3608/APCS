...
public class PrimesUnitTest
{
    ...
    @Test
    public void maxDifferenceTester()
    {
        assertEquals(0, Primes.maxDifference(1));  //2
        assertEquals(2, Primes.maxDifference(3));  //2, 3, 5
        assertEquals(14, Primes.maxDifference(36));
        assertEquals(8,Primes.maxDifference(30)); 
        assertEquals(1, Primes.maxDifference(2));  //2, 3
        assertEquals(4, Primes.maxDifference(6));  // 2, 3, 5, 7, 11, 13
