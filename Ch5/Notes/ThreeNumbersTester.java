...
public class ThreeNumbersTester
{
    ...
    public void testIsGeometricSequence()
    {
        ...
        ThreeNumbers ex7 = new ThreeNumbers(4, 3, 1);
        assertEquals(false, ex7.isGeometricSequence());  // if this returns true, int division error.
    ...
    @Test
    public void testNumberOfRealQuadraticSolutions()
    {
        ThreeNumbers ex1 = new ThreeNumbers();
        assertEquals(0, ex1.numberOfRealQuadraticSolutions());
        ThreeNumbers ex2 = new ThreeNumbers(3, 6, 3);
        assertEquals(1, ex2.numberOfRealQuadraticSolutions());
        ThreeNumbers ex3 = new ThreeNumbers(1, -1, -6);
        assertEquals(2, ex3.numberOfRealQuadraticSolutions());
        ThreeNumbers ex4 = new ThreeNumbers(6, -1, -1);
        assertEquals(2, ex4.numberOfRealQuadraticSolutions());
    }
}
